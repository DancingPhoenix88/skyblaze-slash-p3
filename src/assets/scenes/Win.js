...
class Win extends Phaser.Scene {
    ...
    create () {
        ...
        var _btnNextText = this.add.text(320.0, 856.0, 'NEXT', {"font":"32px DIN Alternate","fill":"#14385a","align":"center"});
        ...
        var _labelWin = this.add.sprite(320.0, 379.0, 'label_win');
        _labelWin.name = 'labelWin';
        _labelWin.setOrigin(0.5, 0.5);
        _labelWin.tint = 0xfeffff;
        
        var _star_1 = this.add.sprite(320.0, 240.0, 'blue_star');
        _star_1.name = 'star_1';
        _star_1.setOrigin(0.5, 0.5);
        _star_1.tint = 0xfeffff;
    ...
    _doAnimate () {
        ...
        this.fLabelWin.setScale( 1.6 );
        this.tweens.add({
            targets: this.fLabelWin,
        ...
        //     .loop()
        //     .start();
        // this.add.tween( this.fLabelWin.scale )
    ...
    //-----------------------------------------------------------------------------------------------------------
    toNextLevel () {
        var lv = this.game.registry.get('user_level') + 1;
        this.game.registry.set('user_level', lv);
        
        if (MasterData.Singleton.getById( 'stage', lv ))
